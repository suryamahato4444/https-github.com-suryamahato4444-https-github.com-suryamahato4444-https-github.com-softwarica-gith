...
ennemy_img=pygame.image.load("car (3).png")
ennemy_img=pygame.transform.scale(ennemy_img,(100,100))
def message(size,mess,x_pos,y_pos):
    font=pygame.font.SysFont(None,size)
    render=font.render(mess,True,white)
    gd.blit(render , (x_pos,y_pos))

message(100,"START",100,300)
clock.tick(1)
...
def ennemy_car(x_r,y_r):
    gd.blit(ennemy_img,(x_r,y_r))
